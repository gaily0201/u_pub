...
public interface IEtlMaintain extends IQueryService{
	 ...
	 public AggBaseInfo[] save(AggBaseInfo[] clientFullVOs,AggBaseInfo[] originBills) throws BusinessException ;

	 public AggBaseInfo[] unsave(AggBaseInfo[] clientFullVOs,AggBaseInfo[] originBills) throws BusinessException ;
}
