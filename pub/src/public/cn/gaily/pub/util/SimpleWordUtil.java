...
public class SimpleWordUtil {
	 ...
	 * @author xiaoh
	 * @since  2014-12-8
	 * <p> history 2014-12-8 xiaoh  创建   <p>
	 */
	public void saveAsPDF(String file){
		Dispatch.invoke(document, "SaveAs", Dispatch.Method, new Object[] {file, new Variant(17) }, new int[1]);
	}
	...
	public void insertFormatStr(String text) {
		...
		Dispatch.put(font, "Color", new Variant("12,11,15,12")); //十六进制转10进制后的8位数字
		Dispatch selection = Dispatch.get(MsWordApp, "Selection").toDispatch();
